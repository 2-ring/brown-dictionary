        ...
        <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4 mt-6 sm:mt-8">
          ...
          {isSignup && (
            <div>
              <input
                ...
                className="w-full px-4 sm:px-6 py-3 sm:py-4 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-400 text-center font-serif text-sm sm:text-base shadow-[0_4px_0_0_rgba(0,0,0,0.25)]"
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 text-gray-600 hover:text-gray-800 transition-colors"
